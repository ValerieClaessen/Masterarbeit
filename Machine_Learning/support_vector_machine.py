...
estimation.test_results("test_set.csv", 7, "bullying_traces_svm.csv", 1)
...
estimation.test_results("test_set.csv", 7, "labeled_data_svm.csv", 1)
estimation.test_results("test_set.csv", 9, "labeled_data_svm_hs.csv", 1)
...
estimation.test_results("test_set.csv", 7, "twitter_hate_speech_svm.csv", 1)
estimation.test_results("test_set.csv", 9, "twitter_hate_speech_svm_hs.csv", 1)
