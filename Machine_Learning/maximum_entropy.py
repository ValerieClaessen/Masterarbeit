...
def do_mem_strength(utterance, lex):
    ...
    p_s1_utterance = e_s1_feature_sum * 1.2 / (e_s1_feature_sum + e_s2_feature_sum + e_s3_feature_sum + e_s4_feature_sum + e_s5_feature_sum)
    p_s2_utterance = e_s2_feature_sum * 1.2 / (e_s1_feature_sum + e_s2_feature_sum + e_s3_feature_sum + e_s4_feature_sum + e_s5_feature_sum)
    p_s3_utterance = e_s3_feature_sum * 1.2 / (e_s1_feature_sum + e_s2_feature_sum + e_s3_feature_sum + e_s4_feature_sum + e_s5_feature_sum)
    p_s4_utterance = e_s4_feature_sum * 1.2 / (e_s1_feature_sum + e_s2_feature_sum + e_s3_feature_sum + e_s4_feature_sum + e_s5_feature_sum)
    p_s5_utterance = e_s5_feature_sum * 1.2 / (e_s1_feature_sum + e_s2_feature_sum + e_s3_feature_sum + e_s4_feature_sum + e_s5_feature_sum)
