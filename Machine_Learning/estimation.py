...
from Machine_Learning import machine_learning_processing
...
def test_results(file1, column1, file2, column2):
    ...
    results = [str_cyberbullying, str_no_cyberbullying, str_right_cyberbullying, str_right_no_cyberbullying, str_wrong_cyberbullying, str_wrong_no_cyberbullying]
...
def test_results_strengths(file1, column1, file2, column2):
    ...
    # compare assigned cyberbullying values
    x = 0
    for item in strength1:  #strength1 = von uns
        if item == 1 or item == "1":
            s1_count += 1
            if strength2[x] == 1 or strength2[x] == "1":
                right_s1 += 1
            elif strength2[x] == 2 or strength2[x] == "2":
                wrong_s1_s2 += 1
            elif strength2[x] == 3 or strength2[x] == "3":
                wrong_s1_s3 += 1
            elif strength2[x] == 4 or strength2[x] == "4":
                wrong_s1_s4 += 1
            elif strength2[x] == 5 or strength2[x] == "5":
                wrong_s1_s5 += 1
        elif item == 2 or item == "2":
            s2_count += 1
            if strength2[x] == 2 or strength2[x] == "2":
                right_s2 += 1
            elif strength2[x] == 1 or strength2[x] == "1":
                wrong_s2_s1 += 1
            elif strength2[x] == 3 or strength2[x] == "3":
                wrong_s2_s3 += 1
            elif strength2[x] == 4 or strength2[x] == "4":
    ...
    list_s1= [right_s1, wrong_s1_s2, wrong_s1_s3, wrong_s1_s4, wrong_s1_s5]
    list_s2= [right_s2, wrong_s2_s1, wrong_s2_s3, wrong_s2_s4, wrong_s2_s5]
    list_s3= [right_s3, wrong_s3_s1, wrong_s3_s2, wrong_s3_s4, wrong_s3_s5]
    list_s4= [right_s4, wrong_s4_s1, wrong_s4_s2, wrong_s4_s3, wrong_s4_s5]
    list_s5= [right_s5, wrong_s5_s1, wrong_s5_s2, wrong_s5_s3, wrong_s5_s4]
    ...
    return(list_s1, list_s2, list_s3, list_s4, list_s5)
# function to estimate precision, recall and accuracy of the algorithm
def estimate(file1, column1, file2, column2):
    cyberbullying1 = machine_learning_processing.make_list_of_column(file1, column1)
    cyberbullying2 = machine_learning_processing.make_list_of_column(file2, column2)
    ...
    #TODO: Bisher übernommen von Sabrina umd die einzelnen Count zu erhalten

    tp = right_cyberbullying
    tn = right_no_cyberbullying
    fn = wrong_cyberbullying
    fp = wrong_no_cyberbullying
...
#test_results("test_set.csv", 7, "twitter_bullying_naive_bayes_sent.csv", 1) #Beispielanwendung
#estimate("test_set.csv", 7, "twitter_bullying_naive_bayes_sent.csv", 1) #Beispielanwendung
