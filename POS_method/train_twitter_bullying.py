...
def train_data_twitter_bullying():
    ##### Lesen der Ausgangssätze #####
    with open('twitter_bullying_files/twitter_bullying_train.csv', 'r') as f8:
        ...
        for row in reader:
            ...
            with open('twitter_bullying_files/twitter_bullying_train_pos.csv', 'a') as f3:
    ...
    with open('twitter_bullying_files/twitter_bullying_train_pos.csv', 'r') as f:
        ...
        for row in reader:
            ...
            with open('twitter_bullying_files/twitter_bullying_train_vec.csv', 'a') as f3:
                writer = csv.writer(f3, delimiter=';')
